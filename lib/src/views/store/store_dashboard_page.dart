              ...
              title: Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      // Use the outer viewModel captured before showing the dialog
                      final success = await viewModel.deleteCoupon(coupon.id);
                      if (!mounted) return;
                      if (success) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              viewModel.errorMessage ?? 'Erro ao excluir cupom',
                            ),
                          ),
                        );
                      }
